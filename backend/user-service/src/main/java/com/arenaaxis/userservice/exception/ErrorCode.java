...
public enum ErrorCode {
  ...
  INVALID_EMAIL(4005, "Invalid email format", HttpStatus.BAD_REQUEST),
  INVALID_NAME(4006, "Name can not contain number or special character", HttpStatus.BAD_REQUEST),
  INVALID_PASSWORD(4007, "Password contains at least one uppercase letter, one lowercase letter, and one number", HttpStatus.BAD_REQUEST),
  ...
  NOT_BLANK_PASSWORD(4018, "Password can not be blank", HttpStatus.BAD_REQUEST),
  NOT_BLANK_EMAIL(4019, "Email can not be blank", HttpStatus.BAD_REQUEST),
  NOT_BLANK_NAME(4026, "Name can not be blank", HttpStatus.BAD_REQUEST),
  MIN_PASSWORD_MSG(4027, "Password contains at least 8 characters", HttpStatus.BAD_REQUEST),
  ACCOUNT_NOT_ACTIVATED(4020, "Account is locked", HttpStatus.FORBIDDEN),
  NOT_BLANK_STORE_NAME(4021, "Name of store can not be blank", HttpStatus.BAD_REQUEST),
  NOT_BLANK_STORE_ADDRESS(4022, "Address of store can not be blank", HttpStatus.BAD_REQUEST),
  INVALID_STORE_NAME(4023, "Invalid name format", HttpStatus.BAD_REQUEST),
  NOT_BLANK_WARD_ID(4024, "Ward id can not be blank", HttpStatus.BAD_REQUEST),
  INVALID_LINK_GOOGLE_MAP(4025, "Invalid link google map format", HttpStatus.BAD_REQUEST),
  ...
  STORE_CANNOT_BE_APPROVED(4018, "Store is not eligible for approval", HttpStatus.BAD_REQUEST),
  SUSPEND_STORE_NOT_EXISTS(4019, "Suspend store not exist", HttpStatus.BAD_REQUEST),
  ;
